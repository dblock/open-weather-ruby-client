...
RSpec.describe 'OpenWeather::Client#weather', vcr: { cassette_name: 'weather/city_name_state_country' } do
  include_context 'API client'

  context 'city, state and country' do
    it 'weather' do
    ...
    it 'city' do
      data = client.city('New York', 'NY', 'US')
      expect(data).to be_a OpenWeather::Models::Data
      expect(data.name).to eq 'New York'
    end
  end
